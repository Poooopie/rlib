...
base.language =
{
    [ 'en' ] =
    {
        ...
        lib_initialized                     = 'server not yet initialized » connect to your server as a player',
        ...
        lib_udm_ok                          = '[udm] » server has latest version » v[ %s ]',
        ...
        lib_setup_phrase_1                  = ' As a final step, please connect to your server and wait until you are loaded in-game.',
        lib_setup_phrase_2                  = ' Then execute the console command',
        lib_setup_phrase_3                  = ' This will add you as a protected \'root user\' with access to all library commands',
        ...
        dc_opt_stay                         = 'STAY',
        dc_opt_leave                        = 'LEAVE',
        logs_clean_threshold                = 'logs dir contains [ %i ] files and [ %i ] subfolders in [ data/%s ] Total size: [ %s ]. Please clean folder using concommand [ %s ]',
        logs_dir_size                       = 'logs dir contains [ %i ] files and [ %i ] subfolders in [ data/%s ] Total size: [ %s ]',
        ...
        debug_help_info_1                   = 'rlib.debug < set:on|off > < duration:# >',
        debug_help_info_2                   = 'rlib.debug on 30',
        debug_receive_err                   = 'error receiving debug msg',
        dialog_key_close                    = 'PRESS %s TO CLOSE',
        entries                             = 'entries',
        err                                 = 'err',
        files_listed_have_been_modified     = 'Files listed below have been modified',
        ...
        rnet_debug_help_info_1              = 'rnet.debug < set:on|off > < duration:# >',
        ...
        status_col_basecmd                  = 'base-command',
        ...
        sys_host_untitled                   = 'untitled server',
