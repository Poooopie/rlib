...
base.language =
{
    [ 'en' ] =
    {
        ...
        dc_opt_stay                         = 'STAY',
        dc_opt_leave                        = 'LEAVE',
        logs_clean_threshold                = 'logs dir has over [ %i ] files in [ data/%s ] Total size: [ %s ]. Please clean folder using concommand [ %s ]',
        logs_dir_size                       = 'logs dir contains [ %i ] files in [ data/%s ] Total size: [ %s ]',
