...
base.language =
{
    [ 'en' ] =
    {
        ...
        mviewer_btn_copytoclip              = 'Click to copy',
        mviewer_btn_copy                    = 'copy',
        mviewer_btn_path                    = 'path',
        mviewer_search_def                  = 'Search',
        mviewer_btn_tip_search              = 'Search',
        mviewer_btn_tip_clear               = 'Clear',
