...
reg_font( pref( 'rcfg_exit' ),                          { size = 24, weight = 800, antialias = true, font = 'Roboto' } )
...
reg_font( pref( 'rcfg_name' ),                          { size = 44, weight = 100, antialias = true, font = 'Roboto Light' } )
...
reg_font( pref( 'rcfg_item_name' ),                     { size = 19, weight = 100, antialias = true, font = 'Roboto' } )
reg_font( pref( 'rcfg_item_ver' ),                      { size = 14, weight = 400, antialias = true, font = 'Roboto' } )
